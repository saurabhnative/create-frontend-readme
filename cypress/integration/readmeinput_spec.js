describe("readme inputs", () => {
  beforeEach(() => {
    cy.visit("/app");
  });

  it("user can add project title, description and socialify image", () => {
  ...
  it("user can add shields io badges", () => {
  ...
  it("user can add installation steps", () => {
