...
export default function PopUpComponent(props) {
  function renderFeaturesInformation() {
    return (
      <div className="md:flex items-center">
        <div className="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
          <p className="font-bold">Showcase features of your project</p>
          <p className="text-sm text-gray-700 mt-1">
            In this section you can add different features for your project
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="md:flex items-center">
        <div className="rounded-full border border-gray-300 flex items-center justify-center w-20 h-20 flex-shrink-0 mx-auto">
          <img
            src="https://res.cloudinary.com/dk22rcdch/image/upload/v1628532270/Blogimages/Screenshot_2021-08-09_at_11.34.23_PM_irow6a.png"
            className="h-8 w-14"
          />
        </div>
        <div className="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
          ...
          <p className="text-sm text-gray-700 mt-1">
            Shields.io, a service for creating legible badges in SVG format,
            which can easily be included in GitHub readmes or any other web
            page.
          </p>
        </div>
      </div>
    ...
    return (
      <div className="md:flex items-center">
        ...
        <div className="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
          ...
          <p className="text-sm text-gray-700 mt-1">
            Socialify helps you showcase your project to the world by generating
            a beautiful project image which can be used in Github README
          </p>
        </div>
      </div>
    );
  ...
  function renderTitleAndDescription() {
    switch (props.source) {
      ...
      case INFO_POPUP_CONTSTANTS.FEATURES_COMPONENT:
        return renderFeaturesInformation();
